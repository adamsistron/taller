...
/**
 * This class adds structure of 'j025t_tipo_evidencia' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class J025tTipoEvidenciaMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.J025tTipoEvidenciaMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(J025tTipoEvidenciaPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(J025tTipoEvidenciaPeer::TABLE_NAME);
		$tMap->setPhpName('J025tTipoEvidencia');
		$tMap->setClassname('J025tTipoEvidencia');
