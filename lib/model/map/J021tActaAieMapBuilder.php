...
/**
 * This class adds structure of 'j021t_acta_aie' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class J021tActaAieMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.J021tActaAieMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(J021tActaAiePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(J021tActaAiePeer::TABLE_NAME);
		$tMap->setPhpName('J021tActaAie');
		$tMap->setClassname('J021tActaAie');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('j021t_acta_aie_co_aie_seq');
