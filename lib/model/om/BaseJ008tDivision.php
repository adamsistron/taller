...
/**
 * Base class that represents a row from the 'j008t_division' table.
 *
 * 
 *
 ...
 */
abstract class BaseJ008tDivision extends BaseObject  implements Persistent {


  const PEER = 'J008tDivisionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        J008tDivisionPeer
	 */
	...
	/**
	 * The value for the tx_division field.
	 * @var        string
	 */
	protected $tx_division;
	...
	/**
	 * Initializes internal state of BaseJ008tDivision object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [tx_division] column value.
	 * 
	 * @return     string
	 */
	public function getTxDivision()
	{
		return $this->tx_division;
	}
	 ...
	 * @return     J008tDivision The current object (for fluent API support)
	 */
	public function setCoDivision($v)
	{
		...
		if ($this->co_division !== $v) {
			$this->co_division = $v;
			$this->modifiedColumns[] = J008tDivisionPeer::CO_DIVISION;
		}
	...
	/**
	 * Set the value of [tx_division] column.
	 * 
	 * @param      string $v new value
	 * @return     J008tDivision The current object (for fluent API support)
	 */
	public function setTxDivision($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->tx_division !== $v) {
			$this->tx_division = $v;
			$this->modifiedColumns[] = J008tDivisionPeer::TX_DIVISION;
		}
	...
	public function setTxSigla($v)
	{
		...
		if ($this->tx_sigla !== $v) {
			$this->tx_sigla = $v;
			$this->modifiedColumns[] = J008tDivisionPeer::TX_SIGLA;
		}
	...
	public function setCoNegocio($v)
	{
		...
		if ($this->co_negocio !== $v) {
			$this->co_negocio = $v;
			$this->modifiedColumns[] = J008tDivisionPeer::CO_NEGOCIO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->co_division = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->tx_division = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->tx_sigla = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->co_negocio = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = J008tDivisionPeer::NUM_COLUMNS - J008tDivisionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating J008tDivision object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = J008tDivisionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJ008tDivision:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			J008tDivisionPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseJ008tDivision:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseJ008tDivision:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJ008tDivision:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			J008tDivisionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = J008tDivisionPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setCoDivision($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += J008tDivisionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = J008tDivisionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = J008tDivisionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = J008tDivisionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCoDivision(),
			$keys[1] => $this->getTxDivision(),
			$keys[2] => $this->getTxSigla(),
			$keys[3] => $this->getCoNegocio(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setCoDivision($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setTxDivision($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setTxSigla($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setCoNegocio($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(J008tDivisionPeer::CO_DIVISION)) $criteria->add(J008tDivisionPeer::CO_DIVISION, $this->co_division);
		if ($this->isColumnModified(J008tDivisionPeer::TX_DIVISION)) $criteria->add(J008tDivisionPeer::TX_DIVISION, $this->tx_division);
		if ($this->isColumnModified(J008tDivisionPeer::TX_SIGLA)) $criteria->add(J008tDivisionPeer::TX_SIGLA, $this->tx_sigla);
		if ($this->isColumnModified(J008tDivisionPeer::CO_NEGOCIO)) $criteria->add(J008tDivisionPeer::CO_NEGOCIO, $this->co_negocio);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(J008tDivisionPeer::CO_DIVISION, $this->co_division);
	...
	/**
	 * Generic method to set the primary key (co_division column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of J008tDivision (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTxDivision($this->tx_division);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     J008tDivision Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     J008tDivisionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new J008tDivisionPeer();
		}
		return self::$peer;
	}
	...
	public function getJ014tNegocio(PropelPDO $con = null)
	{
		if ($this->aJ014tNegocio === null && (($this->co_negocio !== "" && $this->co_negocio !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aJ014tNegocio->addJ008tDivisions($this);
			 */
		}
	 ...
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J002tUsuarios from storage. If this J008tDivision is new, it will return
		...
		if ($this->collJ002tUsuarios === null) {
			if ($this->isNew()) {
			   $this->collJ002tUsuarios = array();
				...
				$criteria->add(J002tUsuarioPeer::CO_DIVISION, $this->co_division);
	 ...
	 * Otherwise if this J008tDivision is new, it will return
	 * an empty collection; or if this J008tDivision has previously
	 * been saved, it will retrieve related J002tUsuarios from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in J008tDivision.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J015tRegionNegocios from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ015tRegionNegocios === null) {
			if ($this->isNew()) {
			   $this->collJ015tRegionNegocios = array();
				...
				$criteria->add(J015tRegionNegocioPeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J016tForenses from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ016tForenses === null) {
			if ($this->isNew()) {
			   $this->collJ016tForenses = array();
				...
				$criteria->add(J016tForensePeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J018tInformeForenses from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ018tInformeForenses === null) {
			if ($this->isNew()) {
			   $this->collJ018tInformeForenses = array();
				...
				$criteria->add(J018tInformeForensePeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J020tActaAccs from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ020tActaAccs === null) {
			if ($this->isNew()) {
			   $this->collJ020tActaAccs = array();
				...
				$criteria->add(J020tActaAccPeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J021tActaAies from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ021tActaAies === null) {
			if ($this->isNew()) {
			   $this->collJ021tActaAies = array();
				...
				$criteria->add(J021tActaAiePeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J022tActaAnies from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ022tActaAnies === null) {
			if ($this->isNew()) {
			   $this->collJ022tActaAnies = array();
				...
				$criteria->add(J022tActaAniePeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J030tInformeRecomendacioness from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ030tInformeRecomendacioness === null) {
			if ($this->isNew()) {
			   $this->collJ030tInformeRecomendacioness = array();
				...
				$criteria->add(J030tInformeRecomendacionesPeer::CO_DIVISION, $this->co_division);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J008tDivision has previously been saved, it will retrieve
	 * related J034tIncidentes from storage. If this J008tDivision is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ034tIncidentes === null) {
			if ($this->isNew()) {
			   $this->collJ034tIncidentes = array();
				...
				$criteria->add(J034tIncidentePeer::CO_DIVISION, $this->co_division);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJ008tDivision:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJ008tDivision::%s', $method));
    }
