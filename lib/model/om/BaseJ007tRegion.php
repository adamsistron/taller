...
/**
 * Base class that represents a row from the 'j007t_region' table.
 *
 * 
 *
 ...
 */
abstract class BaseJ007tRegion extends BaseObject  implements Persistent {


  const PEER = 'J007tRegionPeer';
	...
	/**
	 * Initializes internal state of BaseJ007tRegion object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     J007tRegion The current object (for fluent API support)
	 */
	public function setCoRegion($v)
	{
		...
		if ($this->co_region !== $v) {
			$this->co_region = $v;
			$this->modifiedColumns[] = J007tRegionPeer::CO_REGION;
		}
	...
	public function setTxRegion($v)
	{
		...
		if ($this->tx_region !== $v) {
			$this->tx_region = $v;
			$this->modifiedColumns[] = J007tRegionPeer::TX_REGION;
		}
	...
	public function setTxSigla($v)
	{
		...
		if ($this->tx_sigla !== $v) {
			$this->tx_sigla = $v;
			$this->modifiedColumns[] = J007tRegionPeer::TX_SIGLA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = J007tRegionPeer::NUM_COLUMNS - J007tRegionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating J007tRegion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(J007tRegionPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = J007tRegionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJ007tRegion:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(J007tRegionPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			J007tRegionPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseJ007tRegion:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseJ007tRegion:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJ007tRegion:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			J007tRegionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = J007tRegionPeer::doInsert($this, $con);
					...
					$affectedRows += J007tRegionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = J007tRegionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = J007tRegionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = J007tRegionPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(J007tRegionPeer::DATABASE_NAME);

		if ($this->isColumnModified(J007tRegionPeer::CO_REGION)) $criteria->add(J007tRegionPeer::CO_REGION, $this->co_region);
		if ($this->isColumnModified(J007tRegionPeer::TX_REGION)) $criteria->add(J007tRegionPeer::TX_REGION, $this->tx_region);
		if ($this->isColumnModified(J007tRegionPeer::TX_SIGLA)) $criteria->add(J007tRegionPeer::TX_SIGLA, $this->tx_sigla);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(J007tRegionPeer::CO_REGION, $this->co_region);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of J007tRegion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     J007tRegion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     J007tRegionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new J007tRegionPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J002tUsuarios from storage. If this J007tRegion is new, it will return
		...
		if ($this->collJ002tUsuarios === null) {
			if ($this->isNew()) {
			   $this->collJ002tUsuarios = array();
				...
				$criteria->add(J002tUsuarioPeer::CO_REGION, $this->co_region);
	 ...
	 * Otherwise if this J007tRegion is new, it will return
	 * an empty collection; or if this J007tRegion has previously
	 * been saved, it will retrieve related J002tUsuarios from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in J007tRegion.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J006tSolicituds from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ006tSolicituds === null) {
			if ($this->isNew()) {
			   $this->collJ006tSolicituds = array();
				...
				$criteria->add(J006tSolicitudPeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J009tSerials from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ009tSerials === null) {
			if ($this->isNew()) {
			   $this->collJ009tSerials = array();
				...
				$criteria->add(J009tSerialPeer::CO_REGION, $this->co_region);
	 ...
	 * actually need in J007tRegion.
	 */
	public function getJ009tSerialsJoinJ001tMenu($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(J007tRegionPeer::DATABASE_NAME);
		}
		...
		if ($this->collJ009tSerials === null) {
			if ($this->isNew()) {
				...
				$this->collJ009tSerials = J009tSerialPeer::doSelectJoinJ001tMenu($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J010tEvaluacions from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ010tEvaluacions === null) {
			if ($this->isNew()) {
			   $this->collJ010tEvaluacions = array();
				...
				$criteria->add(J010tEvaluacionPeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J015tRegionNegocios from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ015tRegionNegocios === null) {
			if ($this->isNew()) {
			   $this->collJ015tRegionNegocios = array();
				...
				$criteria->add(J015tRegionNegocioPeer::CO_REGION, $this->co_region);
	 ...
	 * actually need in J007tRegion.
	 */
	public function getJ015tRegionNegociosJoinJ014tNegocio($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(J007tRegionPeer::DATABASE_NAME);
		}
		...
		if ($this->collJ015tRegionNegocios === null) {
			if ($this->isNew()) {
				...
				$this->collJ015tRegionNegocios = J015tRegionNegocioPeer::doSelectJoinJ014tNegocio($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in J007tRegion.
	 */
	public function getJ015tRegionNegociosJoinJ008tDivision($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(J007tRegionPeer::DATABASE_NAME);
		}
		...
		if ($this->collJ015tRegionNegocios === null) {
			if ($this->isNew()) {
				...
				$this->collJ015tRegionNegocios = J015tRegionNegocioPeer::doSelectJoinJ008tDivision($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J016tForenses from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ016tForenses === null) {
			if ($this->isNew()) {
			   $this->collJ016tForenses = array();
				...
				$criteria->add(J016tForensePeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J018tInformeForenses from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ018tInformeForenses === null) {
			if ($this->isNew()) {
			   $this->collJ018tInformeForenses = array();
				...
				$criteria->add(J018tInformeForensePeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J020tActaAccs from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ020tActaAccs === null) {
			if ($this->isNew()) {
			   $this->collJ020tActaAccs = array();
				...
				$criteria->add(J020tActaAccPeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J021tActaAies from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ021tActaAies === null) {
			if ($this->isNew()) {
			   $this->collJ021tActaAies = array();
				...
				$criteria->add(J021tActaAiePeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J022tActaAnies from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ022tActaAnies === null) {
			if ($this->isNew()) {
			   $this->collJ022tActaAnies = array();
				...
				$criteria->add(J022tActaAniePeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J030tInformeRecomendacioness from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ030tInformeRecomendacioness === null) {
			if ($this->isNew()) {
			   $this->collJ030tInformeRecomendacioness = array();
				...
				$criteria->add(J030tInformeRecomendacionesPeer::CO_REGION, $this->co_region);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this J007tRegion has previously been saved, it will retrieve
	 * related J034tIncidentes from storage. If this J007tRegion is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collJ034tIncidentes === null) {
			if ($this->isNew()) {
			   $this->collJ034tIncidentes = array();
				...
				$criteria->add(J034tIncidentePeer::CO_REGION, $this->co_region);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJ007tRegion:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJ007tRegion::%s', $method));
    }
