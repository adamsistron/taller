  ...
  const PEER = 'J015tRegionNegocioPeer';
	...
	public function setCoDivision($v)
	{
		...
		if ($this->co_division !== $v) {
			$this->co_division = $v;
			$this->modifiedColumns[] = J015tRegionNegocioPeer::CO_DIVISION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = J015tRegionNegocioPeer::NUM_COLUMNS - J015tRegionNegocioPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(J015tRegionNegocioPeer::CO_DIVISION)) $criteria->add(J015tRegionNegocioPeer::CO_DIVISION, $this->co_division);
	...
	public function getJ008tDivision(PropelPDO $con = null)
	{
		if ($this->aJ008tDivision === null && (($this->co_division !== "" && $this->co_division !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aJ008tDivision->addJ015tRegionNegocios($this);
			 */
		}
