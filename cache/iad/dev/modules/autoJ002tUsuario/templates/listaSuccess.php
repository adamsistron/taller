...
this.nuevo = new Ext.Button({
    ...
    handler:function(){
        ...
        this.msg.load({
         url:"/taller/web/iad_dev.php/J002tUsuario/editar",
         scripts: true,
         text: "Cargando.."
        });
    }
...
this.editar= new Ext.Button({
	...
	J002tUsuarioLista.main.mascara.show();
        this.msg = Ext.get('formularioJ002tUsuario');
        this.msg.load({
         url:"/taller/web/iad_dev.php/J002tUsuario/editar/codigo/"+this.codigo,
         scripts: true,
         text: "Cargando.."
        });
    }
...
this.eliminar= new Ext.Button({
	...
	if(boton=="yes"){
        Ext.Ajax.request({
            method:'POST',
            url:'/taller/web/iad_dev.php/J002tUsuario/eliminar',
            params:{
...
this.filtro = new Ext.Button({
    ...
    handler:function(){
        ...
        this.msg.load({
             url: '/taller/web/iad_dev.php/J002tUsuario/filtro',
             scripts: true
        });
    }
});
...
getLista: function(){
    ...
    url:'/taller/web/iad_dev.php/J002tUsuario/storelista',
    root:'data',
    fields:[
    {name: 'co_usuario'},
    {name: 'tx_indicador'},
